...
commands.mobileStartService = async function mobileStartService(opts) {
    return /** @type {string} */ (await this.espresso.jwproxy.command('/appium/execute_mobile/start_service', 'POST', (0, utils_1.requireOptions)(opts, ['intent'])));
};
/**
...
commands.mobileStopService = async function mobileStopService(opts) {
    return /** @type {string} */ (await this.espresso.jwproxy.command('/appium/execute_mobile/stop_service', 'POST', (0, utils_1.requireOptions)(opts, ['intent'])));
};
