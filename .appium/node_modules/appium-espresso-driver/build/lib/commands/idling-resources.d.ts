...
export type IdlingResourcesOptions = {
    /**
     * - The comma-separated list of idling resources class names.
...
export namespace commands {
     ...
     */
    function mobileRegisterIdlingResources(this: import("../driver").EspressoDriver, opts: IdlingResourcesOptions): Promise<unknown>;
    /**
     ...
     * the actual instances
     */
    function mobileUnregisterIdlingResources(this: import("../driver").EspressoDriver, opts: IdlingResourcesOptions): Promise<unknown>;
    /**
     ...
     */
    function mobileListIdlingResources(this: import("../driver").EspressoDriver): Promise<string[]>;
    /**
     * Wait for UI thread to be idle.
     * @this {import('../driver').EspressoDriver}
     */
    function mobileWaitForUIThread(this: import("../driver").EspressoDriver): Promise<unknown>;
}
